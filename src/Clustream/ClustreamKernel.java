...
import Clustream.addon.CFCluster;
import weka.core.Instance;


public class ClustreamKernel extends CFCluster {  //...继承CFCluster
    private static final long serialVersionUID = 1L;
    
    private final static double EPSILON = 0.00005; //变量
public static final double MIN_VARIANCE = 1e-50; //最小方差
...
public ClustreamKernel( Instance instance, int dimensions, long timestamp , double t, int m) {  //clusrem内核 
